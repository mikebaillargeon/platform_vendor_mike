...
$(call inherit-product, vendor/mike/products/common.mk)

# Setup device specific product configuration.
PRODUCT_NAME := mike_toro
...
-include vendor/mike/products/common_versions.mk
...
# Inherit drm blobs
-include vendor/mike/products/common_drm.mk
